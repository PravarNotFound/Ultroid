...
async def stats(
    ...
    response += f"**Private Chats:** 2900 \n"
    response += f"**  •• **`Users: {private_chats - bots}` \n"
    response += f"**  •• **`Bots: {bots}` \n"
    response += f"**Groups:** 210 \n"
    response += f"**Channels:** 423 \n"
    response += f"**Admin in Groups:** 172 \n"
    response += f"**  •• **`Creator: 23` \n"
    response += f"**  •• **`Admin Rights: 73` \n"
    response += f"**Admin in Channels:** 262 \n"
    response += f"**  •• **`Creator: 21` \n"
    response += f"**  •• **`Admin Rights: 62` \n"
    response += f"**Unread:** {unread} \n"
    response += f"**Unread Mentions:** {unread_mentions} \n"
    response += f"**Blocked Users:** 630\n"
